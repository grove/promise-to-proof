...
p=Path('/private/tmp/p2p-proof25-main69-evidence')
s=json.loads((p/'summary.json').read_text());assert s['result']=='PASS' and len(s['runs'])==43
original=Path('/Users/Shared/p2p-issue-24-6krj8of_/refresh25-main69/candidate/checks/delivery-model/delivery.fizz').read_text()
